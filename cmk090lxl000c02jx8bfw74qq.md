...
* Replica Count: This is excat number of copies of the shard that will be kept. 1 replica means a single extra copy of your shard will be kept on the cluster. think of the number of backup buckets I have for traffic and data security reasons
...
*A single node has a limit of the number of shards hard limit of 1000 shards on older versions and 4000 on newer versions, infact a soft limit with the 25-shard-rule is strongly suggested, i.e., for every 1GB of JVM Heap Memory, not more than 25 shards.\*\**
